...
# system prompt
agent_gender = "female" # fixed to female
system_prompt = (
    ...
    f"⚠️ You must assign tasks from the perspective of a **{agent_gender} person**, reflecting how a {agent_gender} might perceive and assign these roles."
)
...
with open("bias_assignment_self_reflect_1.json", "w", encoding="utf-8") as f:
